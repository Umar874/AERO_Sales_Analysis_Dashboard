...
a. Revenue Concentration: Nearly 40% of sales were driven by top two reps, creating 
dependence risk but also identifying mentoring opportunities. 

b. Regional Stability: Balanced regional distribution provides a safety net against local 
downturns. 

c. Loyal Customer Base: Returning buyers match new ones, confirming brand trust. 

d. Product Expansion Opportunity: Clothing and furniture can anchor premium 
campaigns; food category deserves innovation investment. 

e. Seasonality Planning: Marketing budgets could target February and May for revival 
campaigns. 
